...
@rnv/core/lib/constants.d.ts:67
...
@rnv/core/lib/constants.d.ts:109
...
@rnv/core/lib/constants.d.ts:96
...
| :------ | :------ |
| `c` | [`RnvContext`](interfaces/RnvContext.md)\<`any`\> |
| `injects` | [`OverridesOptions`](modules.md#overridesoptions) |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `c` | [`RnvContext`](interfaces/RnvContext.md)\<`any`\> | The RnvContext object. |
| `platform` | [`RnvPlatform`](modules.md#rnvplatform) | The RnvPlatform object. |
...
▸ **getPluginList**(`c`, `isUpdate?`): [`PluginListResponse`](modules.md#pluginlistresponse)
...
[`PluginListResponse`](modules.md#pluginlistresponse)
