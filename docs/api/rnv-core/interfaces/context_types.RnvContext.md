---
id: "context_types.RnvContext"
title: "Interface: RnvContext<Payload>"
sidebar_label: "RnvContext"
custom_edit_url: null
---

[context/types](../modules/context_types.md).RnvContext
...
• **buildConfig**: [`RnvContextBuildConfig`](../modules/context_types.md#rnvcontextbuildconfig)
...
• **buildHooks**: `Record`\<`string`, (`c`: [`RnvContext`](context_types.RnvContext.md)\<`any`\>) => `Promise`\<`void`\>\>
...
• **buildPipes**: `Record`\<`string`, (`c`: [`RnvContext`](context_types.RnvContext.md)\<`any`\>) => `Promise`\<`boolean`\>[]\>
...
• **configPropsInjects**: [`OverridesOptions`](../modules/system_types.md#overridesoptions)
...
• **files**: [`RnvContextFiles`](../modules/context_types.md#rnvcontextfiles)
...
• **paths**: [`RnvContextPaths`](../modules/context_types.md#rnvcontextpaths)
...
• **platform**: [`RnvPlatform`](../modules/types.md#rnvplatform)
...
• **program**: [`RnvContextProgram`](../modules/context_types.md#rnvcontextprogram)
...
• **runtime**: [`RnvContextRuntime`](../modules/context_types.md#rnvcontextruntime)
...
• **runtimePropsInjects**: [`OverridesOptions`](../modules/system_types.md#overridesoptions)
...
• **systemPropsInjects**: [`OverridesOptions`](../modules/system_types.md#overridesoptions)
