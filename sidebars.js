...
const sidebars = {
    ...
    tutorialSidebar: [
        ...
        { type: 'category', label: 'Plugins', items: [{ type: 'autogenerated', dirName: 'plugins' }] },
        { label: 'Release Notes', type: 'link', href: 'https://github.com/renative-org/renative/releases' }
    ],
    apiSidebar: [
